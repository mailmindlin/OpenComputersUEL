...
class Screen(val screen: TEScreen) : TextBuffer(screen) {
    ...
    fun isTouchModeInverted(computer: Context, args: Arguments): Result = result(screen.invertTouchMode)
    ...
    fun setTouchModeInverted(computer: Context, args: Arguments): Result {
