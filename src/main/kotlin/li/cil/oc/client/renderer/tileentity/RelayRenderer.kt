...
object RelayRenderer : TileEntitySpecialRenderer<tileentity.Relay>() {
    override fun render(switch: tileentity.Relay, x: Double, y: Double, z: Double, f: Float, damage: Int, alpha: Float) {
