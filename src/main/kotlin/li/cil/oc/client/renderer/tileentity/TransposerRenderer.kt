...
object TransposerRenderer : TileEntitySpecialRenderer<Transposer>() {
    override fun render(transposer: Transposer, x: Double, y: Double, z: Double, f: Float, damage: Int, alpha: Float) {
        ...
        if (activity > 0) {
            ...
            r.pos(0.0, 1.0, 0.0).tex(icon.maxU.toDouble(), icon.minV.toDouble()).endVertex()
            r.pos(1.0, 1.0, 0.0).tex(icon.minU.toDouble(), icon.minV.toDouble()).endVertex()
            ...
            r.pos(0.0, 0.0, 0.0).tex(icon.maxU.toDouble(), icon.maxV.toDouble()).endVertex()
            ...
            r.pos(1.0, 0.0, 0.0).tex(icon.minU.toDouble(), icon.maxV.toDouble()).endVertex()
