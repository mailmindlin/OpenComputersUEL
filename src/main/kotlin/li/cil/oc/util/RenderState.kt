...
object RenderState {
    @JvmField
    val arb: Boolean = GLContext.getCapabilities().GL_ARB_multitexture && !GLContext.getCapabilities().OpenGL13
    ...
    @JvmStatic
    fun compilingDisplayList(): Boolean {
        return if (GL11.glGetInteger(GL11.GL_LIST_INDEX) != 0) {
